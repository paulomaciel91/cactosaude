...
export function Header() {
  ...
  // Dados do usuário atual (mock)
  const currentUser = {
    name: "Dr. João Santos",
    role: "Administrador",
    email: "joao.santos@vidasaudavel.com",
    photo: "",
    ...
    <header className="sticky top-0 z-10 flex h-14 sm:h-16 items-center border-b border-border bg-card">
      <div className="flex items-center h-full w-full px-4 sm:px-6 gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-1 sm:gap-2 min-w-0">
          ...
          <span className="font-semibold text-foreground text-xs sm:text-sm md:text-base truncate">Clínica Vida Saudável</span>
        </div>
                          ...
                          >
                            <div className="flex items-start gap-3">
                              <div className={`mt-0.5 p-1.5 rounded-full ${
                                notification.type === 'appointment' ? 'bg-blue-500/10 text-blue-600' :
